...
- [x] Run the code for the final test
- [x] If the code does what it is supposed to do, do another push into git and go into finishing.
    ```Git Bash
    git add .
    git commit "Finel Test is over!"
    git push o main
    ```
- [x] Delete all folders and files you no longer need.
